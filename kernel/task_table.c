...
__attribute__((always_inline)) inline void task_table_init(TaskTable *tt)
{
    uint32_t i;
...
__attribute__((always_inline)) inline TaskDescriptor *task_table_elem_exchange(TaskTable *tt, TaskDescriptor *td)
{
...
__attribute__((always_inline)) inline void task_table_elem_add(TaskTable *tt, TaskDescriptor *td)
{
