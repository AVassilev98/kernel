...
static inline TaskDescriptor *task_table_elem_pop(TaskTable *tt) __attribute__((always_inline));
...
static inline TaskDescriptor *task_table_elem_pop(TaskTable *tt)
{
    uint32_t mask_lsb = (tt->table_mask) & (-tt->table_mask);
